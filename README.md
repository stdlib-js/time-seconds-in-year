...
```javascript
import secondsInYear from 'https://cdn.jsdelivr.net/gh/stdlib-js/time-seconds-in-year@deno/mod.js';
```
The previous example will load the latest bundled code from the deno branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/time-seconds-in-year/tags). For example,

```javascript
import secondsInYear from 'https://cdn.jsdelivr.net/gh/stdlib-js/time-seconds-in-year@v0.2.3-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/time-seconds-in-year/actions/workflows/test.yml/badge.svg?branch=v0.2.3
[test-url]: https://github.com/stdlib-js/time-seconds-in-year/actions/workflows/test.yml?query=branch:v0.2.3
...
[deno-readme]: https://github.com/stdlib-js/time-seconds-in-year/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/time-seconds-in-year/tree/umd
[umd-readme]: https://github.com/stdlib-js/time-seconds-in-year/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/time-seconds-in-year/tree/esm
[esm-readme]: https://github.com/stdlib-js/time-seconds-in-year/blob/esm/README.md
...
[@stdlib/time/seconds-in-month]: https://github.com/stdlib-js/time-seconds-in-month/tree/deno

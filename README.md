...
```javascript
import secondsInYear from 'https://cdn.jsdelivr.net/gh/stdlib-js/time-seconds-in-year@v0.2.2-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/time-seconds-in-year/actions/workflows/test.yml/badge.svg?branch=v0.2.2
[test-url]: https://github.com/stdlib-js/time-seconds-in-year/actions/workflows/test.yml?query=branch:v0.2.2

...
```javascript
secondsInYear = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/time-seconds-in-year@v0.0.9-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/time-seconds-in-year@v0.0.9-umd/browser.js"></script>
```
